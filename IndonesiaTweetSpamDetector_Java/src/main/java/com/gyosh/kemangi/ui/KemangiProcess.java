...
public class KemangiProcess {
    ...
    public KemangiProcess() throws InterruptedException{
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, InterruptedException {
        ...
        KemangiProcess wordFix=new KemangiProcess();//menjalankan fungsi fungsi dari kemangi
        file = new File("CleanTweet.csv");
        file.createNewFile();
        fw = new FileWriter(file);
        bw = new BufferedWriter(fw);
        Scanner input = new Scanner(new File("tweetresultstem.txt"));//set this back to tweetresult
        try{
